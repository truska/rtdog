...
$productnameDb = mysqli_real_escape_string($conn, $productname1);
$imageDb = mysqli_real_escape_string($conn, $targetfilename);
$sqlinsertimg="INSERT INTO `gallery`
    (`record_id`,`form_id`,`form_name`,`name`,`alttag`,`caption`,`image`,`date`,`folder_name`,`slug`,`keyword`,`sort`)
    VALUES ('$id',2,'products','$productnameDb','','','$imageDb',NOW(),'images/dogs/','','',10)";
