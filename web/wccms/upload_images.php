            ...
            <center>
               <table class="table">
                  ...
                  <tbody id="sortable">
                     ...
                     $sqlgetimg = "SELECT * FROM `gallery`
                        WHERE form_id=2 AND record_id=$id
                     ...
                     while ($resimglist = mysqli_fetch_assoc($querygetimg)) {
                        ...
                        $sort = $sort + 1;
                        // CMS editing previews use the medium desktop derivative.
                        $imgsrc = "../filestore/images/dogs/md/$imgsrc ";
