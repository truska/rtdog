      ...
      if (isset($this->rowformfield["showedit"]) && $this->rowformfield["showedit"] == 'Yes') {
         ...
         if ($this->rowformfield["mediatype"] == 'files') {
            ...
            if ($this->ContentValue) {
               ...
               $output .= "<img src='{$baseURL}/filestore/{$this->rowformfield["mediatype"]}/{$this->rowformfield["file_folder_name"]}/{$this->ContentValue}?$rand' class='pull-right ghai2' style='max-width: 120px;'>";
            } else {
