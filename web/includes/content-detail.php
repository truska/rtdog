<?php
  ...
  $productRoute = getProductDetailRoute($conn);
...
<?php
  ...
  // SET Pedigree etc
    ...
    $renderDogHealthResults = static function (array $dog, bool $showTitle = true): string {
      $value = static fn (string $field): string => htmlspecialchars((string) ($dog[$field] ?? ''), ENT_QUOTES, 'UTF-8');
      $hipValues = array_values(array_filter([$value('hipl'), $value('hipr')], static fn (string $score): bool => $score !== ''));
      $hipScore = implode('/', $hipValues);
      $title = $showTitle ? '<h5 class="mb-3">Health Results</h5>' : '';

      if ($showTitle) {
        return '<div class="mb-4 pt-3 border-top dog-health-results">'
          . $title
          . '<div class="row g-2">'
          . '<div class="col-12 col-sm-6"><div class="row"><div class="col-7">Hip Score:</div><div class="col-5">' . $hipScore . '</div></div></div>'
      ...
      return '<div class="pt-3 border-top dog-health-results">'
        . '<div class="row g-2">'
        . '<div class="col-12"><div class="row"><div class="col-5">Hip:</div><div class="col-7">' . $hipScore . '</div></div></div>'
    ...
    if (!empty($rowproduct['sire'])) {
        ...
        if ($resSire && mysqli_num_rows($resSire) > 0) {
            ...
            $sireLink = $baseURL."/".$productRoute."/".$sireId."/".$sireSlug;
        }
    }
    ...
    if (!empty($rowproduct['dam'])) {
        ...
        if ($resDam && mysqli_num_rows($resDam) > 0) {
            ...
            $damLink = $baseURL."/".$productRoute."/".$damId."/".$damSlug;
        }
    }
...
<div class="container my-4 parent-element">
  ...
  ?>
    ...
    <div class="row g-4 align-items-start">
        ...
        <?= $renderDogHealthResults($rowproduct) ?>
            ...
            <div class="mb-4">
                ...
                <div class="row g-2">
                    <div class="col-6">
                        ...
                        if($sireId) {
                        echo "<strong>Sire:</strong> <a href='".$baseURL."/".$productRoute."/".$sireId."/".$sireSlug."'>" . $sireDisplay."</a>" ;
                          //echo " [idd: ".$sireId."]";
                    ...
                    <div class="col-6">
                        ...
                        if($damId) {
                          echo "<strong>Dam:</strong> <a href='".$baseURL."/".$productRoute."/".$damId."/".$damSlug."'>" . $damDisplay."</a>" ;
                ...
                <div class="row g-2 mt-2">
                    <div class="col-6">
                        <?= $renderDogHealthResults($rowSire ?? [], false) ?>
                    </div>
                    <div class="col-6">
                        <?= $renderDogHealthResults($rowDam ?? [], false) ?>
                    </div>
                </div>
        ...
        if (function_exists('renderGallery')) {
          ...
          $name = trim($name);
            ...
            renderGallery(
              ...
              $name,
              true,
              'zoomMode: off; expand: fullscreen; expandZoomMode: off; hint: off',
              'col-3',
              'sm'
            );
        } else {
        ...
        <?php
          ...
          // Build Generations
            ...
            $horse = [
                ...
                'link' => $baseURL . '/' . $productRoute . '/' . $rowproduct['id'] . '/' . $productSlug,
            ...
            <tbody>
              <tr>
                ...
                <td rowspan="8">
                  ...
                  <?php echo getHorseImage($conn, $baseURL, $horse['id'], null, true); ?>
                </td>
